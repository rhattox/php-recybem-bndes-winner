...
if(!$con) {
 ...
 $sql = "SELECT usuario_id,usuarioNome, SUM(valorDoacao) AS somaTotal FROM doacao,usuario WHERE usuario_id = usuario.usuarioId GROUP BY usuario_id ORDER BY somaTotal DESC";
